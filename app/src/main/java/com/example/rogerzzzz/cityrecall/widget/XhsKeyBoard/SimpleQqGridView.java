...
import com.example.rogerzzzz.cityrecall.widget.XhsKeyBoard.adapter.AppsAdapter;
import com.example.rogerzzzz.cityrecall.widget.XhsKeyBoard.data.AppBean;
...
//        mAppBeanList.add(new AppBean(R.drawable.lcw, "QQ电话"));
//        mAppBeanList.add(new AppBean(R.drawable.lde, "视频电话"));
