...
public class LeftMenuAdapter extends BaseAdapter {
    ...
    private int[] settingIcons = new int[]{R.drawable.iconfont_detail, R.drawable.iconfont_detailcollected, R.drawable.iconfont_setting};
    private String[] settingNames = new String[]{"个人信息", "个人收藏", "设置"};
